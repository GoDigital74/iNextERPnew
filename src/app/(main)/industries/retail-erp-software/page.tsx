  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative bg-ink-950 overflow-hidden pt-24 pb-32">
        ...
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-brand-600/25 rounded-full blur-3xl opacity-70 mix-blend-screen pointer-events-none"></div>
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-accent-600/20 rounded-full blur-3xl opacity-60 mix-blend-screen pointer-events-none"></div>
        ...
        <div className="relative section-container flex flex-col items-center text-center z-10">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white max-w-4xl tracking-tight mb-8">
            Run Every Store the Same Way — Consistently, Accurately, In Real
            Time
          </h1>

          <p className="text-lg text-ink-300 max-w-2xl mb-10 leading-relaxed">
            Whether it's one counter or fifty stores, iNextERP keeps billing
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            <Link
              href="/book-demo"
              className="px-6 py-3 bg-brand-500 hover:bg-brand-600 text-white rounded-xl text-sm font-bold flex items-center justify-center gap-2 transition-colors"
            >
        ...
        <div className="section-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            <div className="card-surface card-surface-hover p-5 flex flex-col min-h-55">
              ...
              <p className="text-[13px] text-ink-500 leading-relaxed">
                Manage unlimited outlets or franchise locations from a single
                login — centralized reporting, unified customer database, and
                consistent pricing/schemes across every store.
              </p>
            </div>
            ...
            <div className="card-surface card-surface-hover p-5 flex flex-col min-h-55">
              ...
              <h3 className="font-bold text-ink-900 text-md mb-3">
                Hybrid POS — Online or Offline, Billing Never Stops
              </h3>
              <p className="text-[13px] text-ink-500 leading-relaxed">
                iNextERP's cloud POS keeps billing locally if your internet
                drops, then syncs automatically once you're back online — no
                lost sales, no manual re-entry.
              </p>
            </div>
            ...
            <div className="card-surface card-surface-hover p-5 flex flex-col min-h-55">
              ...
              <h3 className="font-bold text-ink-900 text-md mb-3">
                Centralized Stock Transfers
              </h3>
              <p className="text-[13px] text-ink-500 leading-relaxed">
                Move stock between stores with automated stock-in/stock-out
                records and full transfer history — no more guessing what's
                actually on which shelf.
              </p>
            </div>
            ...
            <div className="card-surface card-surface-hover p-5 flex flex-col min-h-55">
              ...
              <h3 className="font-bold text-ink-900 text-md mb-3">
                Store-Wise & Consolidated Reporting
              </h3>
              <p className="text-[13px] text-ink-500 leading-relaxed">
                See sales, stock, and staff performance per store or rolled up
                across your entire chain, from one dashboard.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="section-container max-w-3xl">
          ...
          <div className="space-y-4">
            {faqData.map((faq, index) => (
              ...
              >
                <summary className="flex items-center justify-between p-5 cursor-pointer font-bold text-ink-900 text-md hover:text-brand-600 transition-colors">
                  {faq.question}
                  <ChevronDown className="w-5 h-5 text-ink-400 transition-transform group-open:rotate-180 shrink-0 ml-4" />
                </summary>
                <div className="px-5 pb-5 text-sm text-ink-500 leading-relaxed border-t border-ink-150 pt-4 mt-1">
                  {faq.answer}
                </div>
              </details>
            ))}
