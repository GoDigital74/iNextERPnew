...
function FMCGClientComponent() {
  ...
  return (
    <div className="w-full">
      {/* Hero Section */}
      <section className="relative bg-ink-950 pt-24 pb-20 overflow-hidden">
        {/* Gradient Blurs */}
        <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-brand-600/25 rounded-full blur-[120px] opacity-70"></div>
        <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-accent-600/20 rounded-full blur-[100px] opacity-60"></div>

        <div className="section-container relative z-10 text-center max-w-4xl">
          <div className="inline-flex w-fit items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-[13px] font-semibold tracking-wider text-brand-400 uppercase mb-6">
          ...
          <p className="text-lg text-ink-300 mb-10 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/book-demo"
              className="px-6 py-3 bg-brand-500 hover:bg-brand-600 text-white rounded-xl text-sm font-bold w-full sm:w-auto transition-colors"
            >
      ...
      {/* Features Section */}
      <section id="features" className="py-20 bg-ink-50">
        <div className="section-container max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="card-surface card-surface-hover p-5 flex flex-col min-h-55">
              ...
              <h3 className="font-bold text-ink-900 text-md mb-2">Batch & Expiry Tracking</h3>
            ...
            <div className="card-surface card-surface-hover p-5 flex flex-col min-h-55">
              ...
              <h3 className="font-bold text-ink-900 text-md mb-2">Scheme & Discount Management</h3>
              <p className="text-sm text-ink-600">
            ...
            <div className="card-surface card-surface-hover p-5 flex flex-col min-h-55">
              ...
              <h3 className="font-bold text-ink-900 text-md mb-2">Fast-Moving vs. Slow-Moving SKU Analytics</h3>
              <p className="text-sm text-ink-600">
            ...
            <div className="card-surface card-surface-hover p-5 flex flex-col min-h-55">
              ...
              <h3 className="font-bold text-ink-900 text-md mb-2">Multi-Warehouse Stock Visibility</h3>
              <p className="text-sm text-ink-600">
            ...
            <div className="card-surface card-surface-hover p-5 flex flex-col min-h-55">
              ...
              <h3 className="font-bold text-ink-900 text-md mb-2">GST-Compliant Billing at Every Stage</h3>
              <p className="text-sm text-ink-600">
        ...
        <div className="section-container max-w-4xl">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-ink-900 text-md mb-1">Purchase & Receiving</h3>
                <p className="text-sm text-ink-600">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-ink-900 text-md mb-1">Stock & Scheme Application</h3>
                <p className="text-sm text-ink-600">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-ink-900 text-md mb-1">Collections & Reconciliation</h3>
                <p className="text-sm text-ink-600">
      ...
      <section className="py-20 bg-ink-50">
        <div className="section-container max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link href="/services/inventory-management" className="block card-surface card-surface-hover p-5">
              <h3 className="font-bold text-ink-900 text-md mb-2">Inventory Management</h3>
              <p className="text-[13px] text-ink-500">
                batch/expiry tracking, multi-warehouse stock, automated reorder alerts
              </p>
            </Link>

            <Link href="/services/accounts" className="block card-surface card-surface-hover p-5">
              <h3 className="font-bold text-ink-900 text-md mb-2">Accounting</h3>
              <p className="text-[13px] text-ink-500">
                GST compliance, GSTR filing, bank reconciliation
              </p>
            </Link>

            <Link href="/services/erp-integrations" className="block card-surface card-surface-hover p-5">
              <h3 className="font-bold text-ink-900 text-md mb-2">Integrations</h3>
              <p className="text-[13px] text-ink-500">
      ...
      <section className="py-20 bg-white">
        <div className="section-container max-w-3xl">
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <details key={index} className="group card-surface hover:border-brand-300">
                <summary className="flex items-center justify-between p-5 cursor-pointer list-none font-bold text-ink-900 text-md">
                  {faq.q}
                  <span className="transition group-open:rotate-180">
                    <ChevronDown size={20} className="text-ink-400" />
                  </span>
                </summary>
                <div className="px-5 pb-5 text-sm text-ink-500">
                  {faq.a}
                </div>
              </details>
            ))}
      ...
      <section className="py-20 bg-ink-950 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-brand-600/25 to-transparent opacity-70"></div>
        <div className="section-container relative z-10 text-center max-w-3xl">
          ...
          <Link
            href="/book-demo"
            className="inline-flex items-center justify-center px-8 py-4 bg-brand-500 hover:bg-brand-600 text-white rounded-xl text-sm font-bold transition-colors"
          >
            Book an Enterprise Demo
          </Link>
        </div>
