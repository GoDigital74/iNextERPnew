...
function ApparelClient() {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative bg-ink-950 pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-1/2 -left-1/2 w-full h-full bg-brand-600/20 blur-[120px] rounded-full"></div>
          <div className="absolute -bottom-1/2 -right-1/2 w-full h-full bg-accent-600/15 blur-[120px] rounded-full"></div>
        </div>
        ...
        <div className="section-container relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="/contact"
                className="w-full sm:w-auto px-6 py-3 bg-brand-500 hover:bg-brand-600 text-white rounded-xl text-sm font-bold transition-colors"
              >
      ...
      <section className="py-20 bg-ink-50">
        <div className="section-container">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            <details className="group card-surface hover:border-brand-300 [&_summary::-webkit-details-marker]:hidden">
              <summary className="flex items-center justify-between p-5 cursor-pointer font-bold text-ink-900 group-hover:text-brand-600 transition-colors">
                Can iNextERP track inventory by size and color for apparel?
                <ChevronDown className="w-5 h-5 transition-transform group-open:rotate-180 text-ink-400" />
              </summary>
