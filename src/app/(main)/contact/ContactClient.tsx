...
export default function ContactClient() {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#F8FAFC] pt-24 pb-14 font-sans">
            ...
            <div className="bg-gradient-to-br from-[#F4F7F9] to-[#E8F0F7] rounded-3xl p-8 shadow-sm border border-blue-100/60">
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div className="pt-1">
                    <h3 className="text-sm font-bold text-gray-900 mb-1">Talk to an Expert</h3>
                    <div className="flex flex-col gap-1 text-sm font-medium text-gray-600">
                      ...
                      <a href="tel:9211995156" className="hover:text-[#1881c4] transition-colors">9211995156</a>
                    </div>
                  </div>
                </div>
              </div>
