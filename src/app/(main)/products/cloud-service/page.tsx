...
//                 Enterprise Cloud. <br />
//                 Built for Performance<span className="text-[##1881c4]">.</span>
//               </h1>
...
//                 <button className="w-full sm:w-auto px-8 py-3.5 bg-[##1881c4] hover:bg-[#143b2f] text-white rounded-lg font-medium transition-all flex items-center justify-center gap-2">
...
//             <div className="w-12 h-1 bg-[##1881c4] mx-auto mt-4" />
//           </div>
...
//                 <div className="w-14 h-14 mb-5 text-gray-700 group-hover:text-[##1881c4] transition-colors">
...
//                 <div className="mt-auto flex items-center text-xs font-semibold text-gray-900 group-hover:text-[##1881c4]">
...
//               <div className="w-16 h-16 bg-white rounded-xl shadow-sm border border-gray-100 flex items-center justify-center shrink-0 text-[##1881c4]">
...
//               <button className="px-6 py-3 bg-[##1881c4] hover:bg-[#143b2f] text-white rounded-lg font-medium transition-all flex items-center justify-center gap-2 text-sm">
