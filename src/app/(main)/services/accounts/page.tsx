...
//     {
//       "@type": "Question",
//       "name": "Is iNextERP Accounting GST-compliant?",
//       "acceptedAnswer": {
//         "@type": "Answer",
//         "text": "Yes. Every transaction automatically calculates CGST/SGST/IGST, and the module supports GSTR-1, GSTR-3B, and GSTR-9 filing directly from your books."
//       }
//     },
//     {
//       "@type": "Question",
//       "name": "Can I manage multiple companies or business entities in one account?",
//       "acceptedAnswer": {
//         "@type": "Answer",
//         "text": "Yes. iNextERP supports multi-company accounting, so you can maintain separate books for each entity while retaining consolidated visibility."
//       }
//     },
//     {
//       "@type": "Question",
//       "name": "Does iNextERP integrate with Tally?",
//       "acceptedAnswer": {
//         "@type": "Answer",
//         "text": "Yes, iNextERP syncs masters, vouchers, and financial data two-way with Tally, keeping both systems reconciled."
//       }
//     },
//     {
//       "@type": "Question",
//       "name": "How does bank reconciliation work in iNextERP?",
//       "acceptedAnswer": {
//         "@type": "Answer",
//         "text": "Bank statements are imported and auto-matched against your transaction records, flagging only genuine mismatches for manual review instead of requiring line-by-line checking."
//       }
//     },
//     {
//       "@type": "Question",
//       "name": "Can I track TDS and fixed assets in the same system?",
//       "acceptedAnswer": {
//         "@type": "Answer",
//         "text": "Yes. TDS payable, paid, and balance are tracked automatically, and fixed assets are managed with depreciation schedules and net block reporting — no separate spreadsheet needed."
//       }
//     }
//   ]
// };
...
//                 Insights That <span className="text-[#3b82f6]">Grow.</span>
//               </h1>
//               <p className="text-gray-300 text-lg md:text-md max-w-md leading-relaxed mt-2">
//                 Manage your finances with precision. Automate accounting workflows, stay compliant, and get real-time insights to make smarter business decisions.
//               </p>
              
//               {/* SEO Paragraph */}
//               <p className="text-gray-500 text-sm max-w-xl leading-relaxed">
//                 Automate bookkeeping, bank reconciliation & GST filing with iNextERP Accounting. Real-time financial reports for growing Indian businesses.
//               </p>
...
//                 From Transaction<br />to Insight.<br /><span className="text-[#3b82f6]">Fully Automated.</span>
//               </h2>
//               <p className="text-sm text-gray-500 mt-4">Automate your entire accounting process, from creating or importing transactions to system-posted ledgers, bank/expense reconciliation, approval review, real-time financial reports, and finally business decisions — all connected in one flow.</p>
//             </div>
            
//             <div className="lg:w-3/4 w-full flex items-center justify-between overflow-x-auto pb-4 custom-scrollbar gap-2" role="img" aria-label="accounting automation workflow from transaction to business insight">
//               {WORKFLOW_STEPS.map((step, idx) => (
//                 <div key={idx} className="flex items-center shrink-0">
//                   <div className="flex flex-col items-center text-center w-28 md:w-32">
//                     <div className="w-14 h-14 rounded-2xl bg-white border border-gray-200 shadow-sm flex items-center justify-center text-gray-700 mb-4 transition-transform hover:scale-110 relative">
...
//             <div className="xl:col-span-3 flex flex-col gap-6">
//               <div>
//                 <div className="text-blue-500 text-xs font-bold uppercase tracking-wider mb-2">General Ledger & Real-Time Reports</div>
//                 <h2 className="text-3xl font-bold text-gray-900 leading-tight mb-4">
//                   Experience Accounting<br />Like <span className="text-blue-600">Never Before.</span>
//                 </h2>
//                 <p className="text-sm text-gray-500">See every ledger — Cash in Hand, Bank Accounts, Sundry Debtors, Sundry Creditors, Purchase Accounts — with opening balance, debits, credits, and closing balance updated live. Track net profit, cash in hand, and overdue receivables from a single accounting overview dashboard.</p>
//               </div>
//               <div className="flex flex-col gap-1">
//                 {TOUR_TABS.map((tab, i) => (
//                   <button 
...
//              <div className="xl:col-span-1 bg-white border border-gray-100 rounded-2xl p-6 hover:shadow-lg transition-all shadow-sm flex flex-col h-[280px]">
//                <h3 className="font-bold text-gray-900 text-sm mb-2">Flexible Chart of Accounts</h3>
//                <p className="text-[10px] text-gray-500 mb-auto">Customize your chart of accounts — Assets, Liabilities, Income, Expenses, Equity — to match exactly how your business operates, without rigid templates.</p>
//                <div className="mt-4 flex flex-col gap-2">
//                  <div className="flex items-center gap-2 text-[10px] text-gray-700 bg-gray-50 p-1.5 rounded"><Wallet className="w-3 h-3 text-blue-500"/> Assets</div>
//                  <div className="flex items-center gap-2 text-[10px] text-gray-700 bg-gray-50 p-1.5 rounded"><Receipt className="w-3 h-3 text-red-500"/> Liabilities</div>
//                  <div className="flex items-center gap-2 text-[10px] text-gray-700 bg-gray-50 p-1.5 rounded"><TrendingUp className="w-3 h-3 text-green-500"/> Income</div>
...
//              <div className="xl:col-span-1 bg-white border border-gray-100 rounded-2xl p-6 hover:shadow-lg transition-all shadow-sm flex flex-col h-[280px]">
//                <h3 className="font-bold text-gray-900 text-sm mb-2">Voucher Entry</h3>
//                <p className="text-[10px] text-gray-500 mb-auto">Create and manage every voucher type your business needs: Payment, Receipt, Journal, Contra, Debit Note, and Credit Note — from one screen.</p>
//                <div className="mt-4 flex flex-col gap-1.5 text-[10px] text-gray-700 w-full">
//                  <div className="border-b border-gray-50 pb-1">Payment</div>
//                  <div className="border-b border-gray-50 pb-1">Receipt</div>
//                  <div className="border-b border-gray-50 pb-1">Journal</div>
...
//              <div className="xl:col-span-1 bg-white border border-gray-100 rounded-2xl p-6 hover:shadow-lg transition-all shadow-sm flex flex-col h-[280px]">
//                <h3 className="font-bold text-gray-900 text-sm mb-2">Bank Reconciliation</h3>
//                <p className="text-[10px] text-gray-500 mb-auto">Auto-reconcile bank statements and cut manual matching down to minutes.</p>
//                <div className="mt-4">
//                  <div className="flex justify-between items-center mb-4 bg-green-50 p-2 rounded-lg border border-green-100">
//                    <div>
//                      <div className="text-[9px] text-gray-500">Matched</div>
...
//              <div className="xl:col-span-1 bg-white border border-gray-100 rounded-2xl p-6 hover:shadow-lg transition-all shadow-sm flex flex-col h-[280px]">
//                <h3 className="font-bold text-gray-900 text-sm mb-2">GST Management</h3>
//                <p className="text-[10px] text-gray-500 mb-auto">File GSTR-1, GSTR-3B and GSTR-9 returns, generate reports, and stay compliant with the latest GST norms directly from your accounting data.</p>
//                <div className="mt-4 flex flex-col gap-3 text-[10px]">
//                  <div className="flex justify-between items-center"><span className="text-gray-700">GSTR-1</span><span className="text-green-500 font-bold">Filed</span></div>
//                  <div className="flex justify-between items-center"><span className="text-gray-700">GSTR-3B</span><span className="text-green-500 font-bold">Filed</span></div>
//                  <div className="flex justify-between items-center"><span className="text-gray-700">GSTR-9</span><span className="text-blue-500 font-bold">Pending</span></div>
...
//              <div className="xl:col-span-1 bg-white border border-gray-100 rounded-2xl p-6 hover:shadow-lg transition-all shadow-sm flex flex-col h-[280px]">
//                <h3 className="font-bold text-gray-900 text-sm mb-2">TDS Management</h3>
//                <p className="text-[10px] text-gray-500 mb-auto">Track TDS payable and paid, generate certificates, and file on time — with a running TDS balance always visible.</p>
//                <div className="mt-4 flex flex-col gap-4 text-[10px] text-gray-600 w-full">
//                  <div className="flex justify-between items-center border-b border-gray-50 pb-2">
//                    <span className="text-gray-500">TDS Payable</span><span className="font-bold text-gray-900">₹ 1,25,000</span>
//                  </div>
...
//              <div className="xl:col-span-1 bg-white border border-gray-100 rounded-2xl p-6 hover:shadow-lg transition-all shadow-sm flex flex-col h-[280px]">
//                <h3 className="font-bold text-gray-900 text-sm mb-2">Fixed Assets</h3>
//                <p className="text-[10px] text-gray-500 mb-auto">Track asset registers, depreciation schedules, and net block value across your full asset lifecycle.</p>
//                <div className="mt-4 flex justify-between items-end">
//                  <div className="flex flex-col gap-3">
//                    <div>
//                      <div className="text-[9px] text-gray-400">Total Assets</div>
...
//             <div className="bg-white p-10 rounded-3xl border border-gray-100 shadow-sm flex flex-col justify-center">
//               <div className="w-14 h-14 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center mb-6">
//                 <Building2 className="w-7 h-7" />
//               </div>
//               <h3 className="text-2xl font-bold text-gray-900 mb-4">Multi-Company Accounting</h3>
...
//               </div>
//               <h3 className="text-2xl font-bold text-gray-900 mb-4">Audit Trail</h3>
//               <p className="text-gray-600 leading-relaxed">
//                 Every entry is logged with complete transparency — who created it, who approved it, and when — for audit-readiness at any time.
//               </p>
//             </div>
//           </div>
//         </div>
...
//             <div className="p-8 bg-blue-50/50 border border-blue-100 rounded-3xl text-center flex flex-col items-center">
//               <div className="w-16 h-16 bg-white text-blue-600 rounded-full shadow-sm flex items-center justify-center mb-6">
//                 <Calculator className="w-8 h-8" />
//               </div>
//               <h3 className="text-xl font-bold text-gray-900 mb-4">Automated GST Calculation</h3>
//               <p className="text-sm text-gray-600">CGST/SGST/IGST is calculated automatically on every voucher based on HSN/SAC code and place of supply — no manual tax computation.</p>
//             </div>
//             <div className="p-8 bg-green-50/50 border border-green-100 rounded-3xl text-center flex flex-col items-center">
//               <div className="w-16 h-16 bg-white text-green-600 rounded-full shadow-sm flex items-center justify-center mb-6">
//                 <FileText className="w-8 h-8" />
//               </div>
//               <h3 className="text-xl font-bold text-gray-900 mb-4">GSTR-1, GSTR-3B & GSTR-9 Filing Support</h3>
//               <p className="text-sm text-gray-600">Prepare and file returns directly from your books, with reconciliation against purchase and sales registers to catch mismatches before filing.</p>
//             </div>
//             <div className="p-8 bg-purple-50/50 border border-purple-100 rounded-3xl text-center flex flex-col items-center">
//               <div className="w-16 h-16 bg-white text-purple-600 rounded-full shadow-sm flex items-center justify-center mb-6">
//                 <Receipt className="w-8 h-8" />
//               </div>
//               <h3 className="text-xl font-bold text-gray-900 mb-4">E-Invoicing & E-Way Bill Ready</h3>
//               <p className="text-sm text-gray-600">Generate e-invoices and e-way bills where applicable, linked directly to your sales vouchers — no duplicate data entry in a separate portal.</p>
//             </div>
//           </div>
//         </div>
//       </section>
...
//           <h2 className="text-3xl font-bold mb-6">Payment & Bank Integrations</h2>
//           <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 text-left">
//             <div className="bg-white/5 border border-white/10 p-6 rounded-2xl">
//               <h4 className="font-bold text-blue-400 mb-2">Payment Gateways</h4>
//               <p className="text-sm text-gray-300">Razorpay, PhonePe, PayU</p>
//             </div>
//             <div className="bg-white/5 border border-white/10 p-6 rounded-2xl">
//               <h4 className="font-bold text-green-400 mb-2">Bank Reconciliation</h4>
//               <p className="text-sm text-gray-300">Auto-match against major Indian bank statement formats (HDFC, ICICI, SBI, Axis, and others via standard statement import)</p>
//             </div>
//             <div className="bg-white/5 border border-white/10 p-6 rounded-2xl">
//               <h4 className="font-bold text-purple-400 mb-2">Accounting Sync</h4>
//               <p className="text-sm text-gray-300">Two-way integration with Tally for masters, vouchers, and financial data</p>
//             </div>
//           </div>
//         </div>
//       </section>
...
//               }
//             ].map((faq, idx) => (
//               <div key={idx} className="bg-[#F8FAFC] border border-gray-100 rounded-2xl p-6">
...
export default function AccountingPage() {
  ...
  return (
    <main className="flex-1 flex flex-col w-full bg-[#FAFAFA] font-sans">
      ...
      {/* 1. HERO SECTION (Dark) - Reduced Text */}
      ...
      <section className="py-20 bg-[#F8FAFC]">
        <div className="container mx-auto px-6 max-w-[1400px]">
          <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
            ...
            <div className="xl:col-span-6 bg-[#0F172A] rounded-[2rem] p-6 md:p-8 shadow-2xl border border-gray-800 flex flex-col gap-5 transition-all duration-300 text-white">
               <div className="flex justify-between items-center border-b border-gray-700 pb-3">
                 <h3 className="font-bold text-lg">{TOUR_CONTENT[activeTab].title}</h3>
                 <div className="flex gap-2">
                   <div className="bg-gray-800 text-[10px] px-2.5 py-1.5 rounded-lg text-gray-300">Export PDF</div>
                   <div className="bg-blue-600 font-bold text-[10px] px-2.5 py-1.5 rounded-lg">View Details</div>
                 </div>
               </div>
               ...
               <div className="grid grid-cols-2 gap-4">
                 {TOUR_CONTENT[activeTab].metrics.map((metric, idx) => (
                   <div key={idx} className="bg-gray-800/50 p-4 rounded-xl border border-gray-700">
                     <div className="text-xs text-gray-400 mb-1">{metric.l}</div>
               ...
               <div className="flex-1 mt-2 bg-gray-800/20 rounded-xl border border-gray-700/50 p-4 flex flex-col gap-3">
                 <div className="w-full h-4 bg-gray-700/50 rounded-sm"></div>
                 <div className="w-3/4 h-4 bg-gray-700/30 rounded-sm"></div>
                 <div className="w-full h-4 bg-gray-700/30 rounded-sm"></div>
                 <div className="w-5/6 h-4 bg-gray-700/30 rounded-sm"></div>
                 <div className="w-full h-4 bg-gray-700/30 rounded-sm"></div>
               </div>
            </div>
            ...
            <div className="xl:col-span-3 flex justify-center items-center relative" role="img" aria-label="mobile accounting app interface">
              <div className="w-[240px] h-[500px] bg-[#0A0F1C] rounded-[2rem] border-[6px] border-gray-900 shadow-2xl relative overflow-hidden flex flex-col text-white">
                ...
                <div className="flex-1 px-4 py-4 flex flex-col gap-4 overflow-y-auto pb-16 custom-scrollbar">
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-xl p-3">
                    <div className="text-[9px] text-gray-400 mb-1">{TOUR_CONTENT[activeTab].metrics[0].l}</div>
                    <div className="text-lg font-bold text-white">{TOUR_CONTENT[activeTab].metrics[0].v}</div>
                  </div>

                  <div className="bg-white/5 border border-white/10 rounded-xl p-3">
                    <div className="text-[9px] text-gray-400 mb-1">{TOUR_CONTENT[activeTab].metrics[1].l}</div>
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-xl p-3 mt-2">
                     <h5 className="text-[9px] font-bold text-gray-300 mb-2">Quick Action</h5>
                ...
                <div className="absolute bottom-0 inset-x-0 h-12 bg-[#0A0F1C] border-t border-white/10 flex justify-around items-center px-3">
                  ...
                  <div className="flex flex-col items-center text-gray-500"><FileText className="w-4 h-4 mb-0.5" /><div className="text-[8px]">Ledgers</div></div>
                  <div className="flex flex-col items-center text-gray-500"><BarChart className="w-4 h-4 mb-0.5" /><div className="text-[8px]">Reports</div></div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6 max-w-[1400px]">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 text-sm md:text-base mt-4 max-w-2xl mx-auto">Everything you need to automate workflows, ensure compliance, and scale your financial operations.</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
             
             {/* Feature 1 */}
             <div className="bg-white border border-gray-100 rounded-2xl p-8 hover:shadow-xl transition-all shadow-sm flex flex-col min-h-[320px]">
               <div className="w-12 h-12 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center mb-6">
                 <Wallet className="w-6 h-6" />
               </div>
               <h3 className="font-bold text-gray-900 text-xl mb-3">Flexible Chart of Accounts</h3>
               <p className="text-sm text-gray-500 mb-6 leading-relaxed">Customize your chart of accounts — Assets, Liabilities, Income, Expenses, Equity — to match exactly how your business operates, without rigid templates.</p>
               <div className="mt-auto flex flex-col gap-2">
                 <div className="flex items-center gap-3 text-xs text-gray-700 bg-gray-50 p-2.5 rounded-lg"><CheckCircle2 className="w-4 h-4 text-blue-500"/> Multi-level Grouping</div>
                 <div className="flex items-center gap-3 text-xs text-gray-700 bg-gray-50 p-2.5 rounded-lg"><CheckCircle2 className="w-4 h-4 text-blue-500"/> Custom Group Types</div>
               </div>
             </div>
             ...
             <div className="bg-white border border-gray-100 rounded-2xl p-8 hover:shadow-xl transition-all shadow-sm flex flex-col min-h-[320px]">
               ...
               <h3 className="font-bold text-gray-900 text-xl mb-3">Voucher Entry</h3>
               <p className="text-sm text-gray-500 mb-6 leading-relaxed">Create and manage every voucher type your business needs: Payment, Receipt, Journal, Contra, Debit Note, and Credit Note — all from one intuitive screen.</p>
               <div className="mt-auto grid grid-cols-2 gap-2 text-xs text-gray-700 font-medium">
                 <div className="bg-gray-50 py-2 px-3 rounded text-center">Payment</div>
                 <div className="bg-gray-50 py-2 px-3 rounded text-center">Receipt</div>
                 <div className="bg-gray-50 py-2 px-3 rounded text-center">Journal</div>
                 <div className="bg-gray-50 py-2 px-3 rounded text-center">Contra</div>
               </div>
             </div>
             ...
             <div className="bg-white border border-gray-100 rounded-2xl p-8 hover:shadow-xl transition-all shadow-sm flex flex-col min-h-[320px]">
               ...
               <h3 className="font-bold text-gray-900 text-xl mb-3">Bank Reconciliation</h3>
               <p className="text-sm text-gray-500 mb-6 leading-relaxed">Auto-reconcile bank statements and cut manual matching down to minutes. Match hundreds of transactions with just a few clicks.</p>
               <div className="mt-auto border border-gray-100 rounded-xl overflow-hidden">
                 <div className="flex justify-between items-center bg-green-50 p-3">
                   <div className="text-xs font-bold text-gray-900">Matched (1,250)</div>
                   <CheckCircle2 className="w-4 h-4 text-green-600" />
                 </div>
                 <div className="flex justify-between items-center p-3 border-t border-gray-100">
                   <div className="text-xs text-gray-500">Unmatched (25)</div>
                 </div>
               </div>
             </div>
             ...
             <div className="bg-white border border-gray-100 rounded-2xl p-8 hover:shadow-xl transition-all shadow-sm flex flex-col min-h-[320px]">
               ...
               <h3 className="font-bold text-gray-900 text-xl mb-3">GST Management</h3>
               <p className="text-sm text-gray-500 mb-6 leading-relaxed">File GSTR-1, GSTR-3B and GSTR-9 returns, generate reports, and stay completely compliant with the latest GST norms directly from your accounting data.</p>
               <div className="mt-auto flex flex-col gap-3 text-xs">
                 <div className="flex justify-between items-center"><span className="font-medium text-gray-700">GSTR-1</span><span className="bg-green-100 text-green-700 px-2 py-1 rounded font-bold">Filed</span></div>
                 <div className="flex justify-between items-center"><span className="font-medium text-gray-700">GSTR-3B</span><span className="bg-green-100 text-green-700 px-2 py-1 rounded font-bold">Filed</span></div>
               </div>
             </div>
             ...
             <div className="bg-white border border-gray-100 rounded-2xl p-8 hover:shadow-xl transition-all shadow-sm flex flex-col min-h-[320px]">
               ...
               <h3 className="font-bold text-gray-900 text-xl mb-3">TDS Management</h3>
               <p className="text-sm text-gray-500 mb-6 leading-relaxed">Track TDS payable and paid, generate certificates, and file on time — with a running TDS balance always visible in your dashboard.</p>
               <div className="mt-auto flex flex-col gap-3 text-sm text-gray-700 w-full bg-gray-50 p-4 rounded-xl">
                 <div className="flex justify-between items-center border-b border-gray-200 pb-2">
                   <span className="text-gray-500">TDS Payable</span><span className="font-bold">₹ 1,25,000</span>
                 </div>
                 <div className="flex justify-between items-center pt-1">
                   <span className="text-gray-500">TDS Balance</span><span className="font-bold text-blue-600">₹ 30,000</span>
                 </div>
               </div>
             </div>
             ...
             <div className="bg-white border border-gray-100 rounded-2xl p-8 hover:shadow-xl transition-all shadow-sm flex flex-col min-h-[320px]">
               ...
               <h3 className="font-bold text-gray-900 text-xl mb-3">Fixed Assets</h3>
               <p className="text-sm text-gray-500 mb-6 leading-relaxed">Track asset registers, depreciation schedules, and net block value across your full asset lifecycle without external spreadsheets.</p>
               <div className="mt-auto flex justify-between items-end bg-blue-50/50 p-4 rounded-xl border border-blue-100">
                 <div className="flex flex-col gap-2">
                   <div>
                     <div className="text-[10px] uppercase font-bold text-gray-400">Total Assets</div>
                     <div className="text-lg font-bold text-gray-900">125</div>
                   </div>
                   <div>
                     <div className="text-[10px] uppercase font-bold text-gray-400">Net Block</div>
                     <div className="text-lg font-bold text-blue-600">₹ 46.2L</div>
                   </div>
                 </div>
                 <PieChart className="w-10 h-10 text-blue-400 opacity-50 mb-2" />
               </div>
             </div>
        ...
        <div className="container mx-auto px-6 max-w-[1400px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-8 bg-blue-50/50 border border-blue-100 rounded-3xl text-center flex flex-col items-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-3">Automated GST Calculation</h3>
              <p className="text-sm text-gray-600 leading-relaxed">CGST/SGST/IGST is calculated automatically on every voucher based on HSN/SAC code and place of supply — no manual tax computation.</p>
            </div>
            <div className="p-8 bg-green-50/50 border border-green-100 rounded-3xl text-center flex flex-col items-center">
              <div className="w-16 h-16 bg-white text-green-600 rounded-full shadow-sm flex items-center justify-center mb-6">
                <FileText className="w-8 h-8" />
              </div>
              <h3 className="text-lg font-bold text-gray-900 mb-3">GSTR-1, 3B & 9 Support</h3>
              <p className="text-sm text-gray-600 leading-relaxed">Prepare and file returns directly from your books, with reconciliation against purchase and sales registers to catch mismatches before filing.</p>
            </div>
            <div className="p-8 bg-purple-50/50 border border-purple-100 rounded-3xl text-center flex flex-col items-center">
              <div className="w-16 h-16 bg-white text-purple-600 rounded-full shadow-sm flex items-center justify-center mb-6">
                <Receipt className="w-8 h-8" />
              </div>
              <h3 className="text-lg font-bold text-gray-900 mb-3">E-Invoicing & E-Way Bill Ready</h3>
              <p className="text-sm text-gray-600 leading-relaxed">Generate e-invoices and e-way bills where applicable, linked directly to your sales vouchers — no duplicate data entry in a separate portal.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#0F172A] text-white text-center">
        <div className="container mx-auto px-6 max-w-[1000px]">
          ...
          <p className="text-gray-400 mb-10 max-w-2xl mx-auto">Seamlessly connect your business bank accounts and payment gateways to keep cash flow data live and accurate.</p>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            <div className="bg-white/5 border border-white/10 p-6 rounded-2xl">
              <h4 className="font-bold text-blue-400 mb-3 text-lg">Payment Gateways</h4>
              <p className="text-sm text-gray-300 leading-relaxed">Collect payments easily via integrated links supporting Razorpay, PhonePe, and PayU directly on your invoices.</p>
            </div>
            <div className="bg-white/5 border border-white/10 p-6 rounded-2xl">
              <h4 className="font-bold text-green-400 mb-3 text-lg">Bank Reconciliation</h4>
              <p className="text-sm text-gray-300 leading-relaxed">Auto-match against major Indian bank statement formats (HDFC, ICICI, SBI, Axis, etc.) via standard statement imports.</p>
            </div>
            <div className="bg-white/5 border border-white/10 p-6 rounded-2xl">
              <h4 className="font-bold text-purple-400 mb-3 text-lg">Accounting Sync</h4>
              <p className="text-sm text-gray-300 leading-relaxed">Two-way reliable integration with Tally for masters, vouchers, and financial data synchronization.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#F8FAFC] border-t border-gray-100">
        <div className="container mx-auto px-6 max-w-[1400px]">
          <div className="text-center mb-10">
             <h2 className="text-2xl md:text-3xl font-bold text-gray-900 leading-tight mb-2">Before iNextERP vs After</h2>
          </div>
            ...
            <div className="flex-1 bg-white relative flex items-center overflow-hidden p-8 md:p-12">
               ...
               <div className="relative z-10 flex flex-col md:flex-row gap-8 w-full">
                 ...
                 <div className="flex flex-col justify-center gap-3 shrink-0">
                    <div className="bg-white border border-gray-100 shadow-md rounded-xl p-4 w-44 md:w-48 relative overflow-hidden">
                      <div className="text-[10px] text-gray-400 font-bold uppercase mb-1">Net Profit</div>
                      <div className="text-xl font-bold text-gray-900">₹ 56.3L</div>
                      <div className="text-[10px] font-bold text-green-500 mt-1">↑ 15.6%</div>
                      <div className="mt-3 opacity-50">
                        <svg className="w-full h-6 text-blue-500" preserveAspectRatio="none" viewBox="0 0 100 100">
                          <polyline fill="none" stroke="currentColor" strokeWidth="4" points="0,80 20,60 40,70 60,30 80,40 100,10" />
                        </svg>
                      </div>
                    </div>
                    <div className="bg-white border border-gray-100 shadow-md rounded-xl p-4 w-44 md:w-48">
                      <div className="text-[10px] text-gray-400 font-bold uppercase mb-1">Cash in Hand</div>
                      <div className="text-xl font-bold text-gray-900">₹ 18.7L</div>
                      <div className="text-[10px] font-bold text-green-500 mt-1">↑ 9.1%</div>
                    </div>
                 </div>
               </div>
