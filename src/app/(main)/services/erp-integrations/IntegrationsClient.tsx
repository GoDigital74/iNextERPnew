...
const INTEGRATIONS_DATA = [
  ...
  },
  {
    ...
    icon: Fingerprint, iconColor: "text-brand-600", bg: "bg-brand-50",
    uiType: "biometric"
  }
];
...
export default function IntegrationsClient() {
  ...
  return (
    <main className="flex-1 flex flex-col w-full bg-white font-sans text-ink-900">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-12 gap-12 items-center">
            ...
            <div className="flex flex-col gap-5 xl:col-span-5">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3 mt-4">
                <button className="w-full sm:w-auto px-6 py-3.5 bg-brand-500 hover:bg-brand-400 text-white rounded-xl text-sm font-bold transition-all shadow-[0_0_20px_rgba(24,129,196,0.45)] flex items-center justify-center gap-2">
            ...
            <div className="xl:col-span-7 flex flex-col md:flex-row items-center gap-8 justify-end">
              <div className="relative w-full max-w-87.5 aspect-square scale-90 md:scale-100 flex-shrink-0">
                 ...
                 {[
                   ...
                   <div key={i} className="absolute w-12 h-12 bg-ink-800 border border-white/10 rounded-full flex items-center justify-center -translate-x-1/2 -translate-y-1/2 z-10 shadow-lg"
        ...
        <div className="section-container max-w-[1400px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
             {INTEGRATIONS_DATA.map((integration, idx) => (
               <div key={idx} className="card-surface card-surface-hover p-5 flex flex-col h-65">
      ...
      {/* 4. LIVE SYNC IN ACTION (Dark accent panel) */}
      <section className="py-20 bg-white border-b border-ink-150">
        <div className="section-container max-w-[1400px]">
          ...
          <div className="bg-ink-950 rounded-3xl p-6 md:p-12 relative flex flex-col max-w-5xl mx-auto">
        ...
        <div className="section-container max-w-[1400px]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
             ...
             <div className="flex flex-col gap-6">
               ...
               <button className="w-max px-6 py-3.5 bg-brand-500 hover:bg-brand-600 text-white rounded-xl font-bold transition-all flex items-center justify-center gap-2 shadow-md">
                 Explore API Docs <ArrowRight className="w-4 h-4" />
               </button>
             </div>

             {/* Code Snippet Block */}
             <div className="bg-ink-950 rounded-3xl p-6 md:p-8 flex-1 flex flex-col shadow-xl">
...
{`{
  ...
  "`}<span className="text-brand-300">data</span>{`": [
    ...
    {"`}<span className="text-brand-300">id</span>{`": `}<span className="text-orange-400">102</span>{`, "`}<span className="text-brand-300">name</span>{`": "`}<span className="text-emerald-400">Sneha Kapoor</span>{`"}
      ...
      <section className="py-20 bg-white border-t border-ink-150">
        <div className="section-container max-w-[1400px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
             ...
             <div className="card-surface card-surface-hover p-6 flex flex-col items-start lg:col-span-1 md:col-span-2">
               ...
               <p className="text-ink-600 text-xs leading-relaxed">Automated SMS/WhatsApp triggers on order confirmation, dispatch, and payment — reducing "where's my order" support queries.</p>
             </div>
             <div className="card-surface card-surface-hover p-6 flex flex-col items-start lg:col-span-2 md:col-span-2">
      ...
      {/* 7. SECURE, RELIABLE, ENTERPRISE READY (Dark accent band) */}
      ...
      {/* 9. FINAL CTA SECTION (Dark accent band) */}
          ...
          <div className="relative rounded-[2rem] overflow-hidden bg-ink-950 flex flex-col md:flex-row items-stretch justify-between shadow-2xl">
            ...
            <div className="md:w-1/2 p-10 lg:p-16 z-10 relative text-white flex flex-col justify-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="px-6 py-3.5 bg-brand-500 hover:bg-brand-400 text-white rounded-lg font-bold transition-all flex items-center justify-center gap-2 text-sm shadow-xl">
                  Book an Enterprise Demo <ArrowRight className="w-4 h-4" />
                </button>
                <a
