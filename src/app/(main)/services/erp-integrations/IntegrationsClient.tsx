...
const INTEGRATIONS_DATA = [
  { 
    title: "Shopify", 
    desc: "Sync orders, inventory, customers & more in real time.", 
    icon: ShoppingBag, iconColor: "text-[#1881c4]", bg: "bg-blue-50",
    uiType: "order"
  },
  { 
    title: "WooCommerce", 
    desc: "Sync products, orders & customers, with live stock visibility.", 
    icon: ShoppingCart, iconColor: "text-[#1881c4]", bg: "bg-blue-50",
    uiType: "product"
  },
  { 
    title: "Amazon", 
    desc: "Automate orders, pricing, inventory & returns across your seller account.", 
    icon: Package, iconColor: "text-[#1881c4]", bg: "bg-blue-50",
    uiType: "shipping"
  },
  { 
    title: "Razorpay", 
    desc: "Automate payments, refunds & reconciliation with automatic status updates.", 
    icon: CreditCard, iconColor: "text-[#1881c4]", bg: "bg-blue-50",
    uiType: "payment", amount: "₹ 8,560", status: "Settled"
  },
  { 
    title: "PhonePe", 
    desc: "Receive payments & reconcile automatically against sales records.", 
    icon: Smartphone, iconColor: "text-[#1881c4]", bg: "bg-blue-50",
    uiType: "payment", amount: "₹ 5,230", status: "Success"
  },
  { 
    title: "WhatsApp Business", 
    desc: "Send order confirmations, invoices & delivery updates instantly.", 
    icon: MessageCircle, iconColor: "text-[#1881c4]", bg: "bg-blue-50",
    uiType: "message"
  },
  { 
    title: "GST (GSTN)", 
    desc: "Auto GST calculation, filing & reconciliation visible in dashboard.", 
    icon: FileText, iconColor: "text-[#1881c4]", bg: "bg-blue-50",
    uiType: "tax"
  },
  { 
    title: "Tally", 
    desc: "Sync masters, vouchers & financial data two-way.", 
    icon: Calculator, iconColor: "text-[#1881c4]", bg: "bg-blue-50",
    uiType: "tally"
  },
  { 
    title: "Google Drive", 
    desc: "Store & access documents securely, synced automatically.", 
    icon: Cloud, iconColor: "text-[#1881c4]", bg: "bg-blue-50",
    uiType: "file", fileName: "Invoice_1001.pdf"
  },
  { 
    title: "Excel / CSV", 
    desc: "Import & export data seamlessly for bulk updates.", 
    icon: Table, iconColor: "text-[#1881c4]", bg: "bg-blue-50",
    uiType: "file", fileName: "Customers.xlsx"
  },
  { 
    title: "Barcode Scanner", 
    desc: "Scan, track & manage inventory directly at the billing counter.", 
    icon: ScanBarcode, iconColor: "text-[#1881c4]", bg: "bg-blue-50",
    uiType: "scan"
  },
  { 
    title: "Handheld Scanners", 
    desc: "Android-based handhelds for warehouse picking and bulk receiving.", 
    icon: Smartphone, iconColor: "text-[#1881c4]", bg: "bg-blue-50",
    uiType: "scan"
  },
  { 
    title: "Biometric Device", 
    desc: "Sync attendance records automatically into HRM.", 
    icon: Fingerprint, iconColor: "text-[#1881c4]", bg: "bg-blue-50",
    uiType: "biometric"
  }
];
    ...
    case "file":
      return (
        <div className="bg-white border border-gray-100 rounded-xl p-3 shadow-sm text-xs mt-auto flex items-center gap-3">
          <div className="w-8 h-8 bg-blue-50 text-[#1881c4] flex items-center justify-center rounded-lg"><FileText className="w-4 h-4"/></div>
          <div>
...
export default function IntegrationsClient() {
  ...
  return (
    <main className="flex-1 flex flex-col w-full bg-[#FAFAFA] font-sans text-gray-900">
      
      {/* 1. HERO SECTION (Dark) */}
      <section className="relative bg-[#060B19] text-white pt-28 pb-32 overflow-hidden">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#1881c4]/20 blur-[120px] rounded-full" />
        </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-12 gap-12 items-center">
            ...
            <div className="flex flex-col gap-5 xl:col-span-5">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3 mt-4">
                <button className="w-full sm:w-auto px-6 py-3.5 bg-[#1881c4] hover:bg-[#12659a] text-white rounded-xl text-sm font-bold transition-all shadow-[0_0_20px_rgba(24,129,196,0.4)] flex items-center justify-center gap-2">
                  Book an Enterprise Demo <ArrowRight className="w-4 h-4" />
                </button>
                <button className="w-full sm:w-auto px-6 py-3.5 bg-transparent border border-white/20 hover:bg-white/5 text-white rounded-xl text-sm font-bold transition-all flex items-center justify-center">
                  Explore Integrations
                </button>
              </div>

              {/* Trust Strip */}
              <div className="flex flex-wrap items-center gap-x-4 gap-y-2 mt-4 pt-4 border-t border-white/10">
                {["Pre-built Connectors", "Real-time Sync", "Secure & Reliable"].map((item) => (
                  <div key={item} className="flex items-center gap-1.5 text-xs text-gray-300 font-medium">
                    <CheckCircle2 className="w-3.5 h-3.5 text-[#1881c4]" /> {item}
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="xl:col-span-7 flex flex-col md:flex-row items-center gap-8 justify-end">
              <div className="relative w-full max-w-[350px] aspect-square scale-90 md:scale-100 flex-shrink-0">
                 {/* Connecting Lines SVG */}
                 <svg className="absolute inset-0 w-full h-full text-[#1881c4]/30" xmlns="http://www.w3.org/2000/svg">
                 ...
                 {/* Center Node */}
                 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-28 h-28 bg-[#0A1022] border-2 border-[#1881c4] rounded-2xl flex flex-col items-center justify-center shadow-[0_0_40px_rgba(24,129,196,0.6)] z-20">
                 ...
                 {/* Satellite Nodes */}
                 {[
                   { icon: ShoppingBag, color: "text-[#1881c4]", top: "5%", left: "50%" },
                   { icon: Package, color: "text-[#1881c4]", top: "20%", left: "85%" },
                   { icon: MessageCircle, color: "text-[#1881c4]", top: "50%", left: "95%" },
                   { icon: Calculator, color: "text-[#1881c4]", top: "80%", left: "85%" },
                   { icon: FileText, color: "text-[#1881c4]", top: "95%", left: "50%" },
                   { icon: Smartphone, color: "text-[#1881c4]", top: "80%", left: "15%" },
                   { icon: Cloud, color: "text-[#1881c4]", top: "50%", left: "5%" },
                   { icon: ShoppingCart, color: "text-[#1881c4]", top: "20%", left: "15%" },
                 ].map((node, i) => (
                 ...
                 {[
                   ...
                   <div key={i} className="bg-[#0B1221] border border-white/10 p-4 rounded-xl flex items-center gap-4">
                     <div className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center shrink-0 border border-white/5">
                       <feat.icon className="w-5 h-5 text-[#1881c4]" />
                     </div>
                     <div>
          ...
          <div className="flex flex-col xl:flex-row gap-10 items-center">
            <div className="xl:w-1/4 shrink-0 text-center xl:text-left">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 leading-tight">
                Connected Workflow —<br />From One App to Another, Data Flows, <span className="text-[#1881c4]">Business Grows.</span>
              </h2>
            </div>
              ...
              {WORKFLOW_STEPS.map((step, idx) => (
                <div key={idx} className="flex items-start xl:items-center justify-center xl:justify-start relative">
                  <div className="flex flex-col items-center text-center w-full max-w-[120px]">
                    <div className="w-12 h-12 rounded-xl bg-blue-50 border border-blue-100 flex items-center justify-center text-[#1881c4] mb-3 shadow-sm hover:scale-105 transition-transform">
      ...
      <section className="py-20 bg-white border-b border-gray-100">
        <div className="container mx-auto px-6 max-w-[1400px]">
          <div className="text-center mb-10">
             <h2 className="text-2xl md:text-3xl font-bold text-gray-900 leading-tight mb-3">Live Sync in Action</h2>
          ...
          <div className="bg-[#0B1221] border border-gray-800 rounded-3xl p-6 md:p-12 relative flex flex-col max-w-5xl mx-auto">
             <div className="flex flex-col md:flex-row gap-5 h-full relative z-10">
               
               {/* Shopify Panel */}
               <div className="flex-1 bg-[#151D30] rounded-xl p-6 border border-white/5 shadow-xl">
               ...
               {/* Sync Arrow Graphic */}
               <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-14 h-14 bg-[#0B1221] rounded-full border-2 border-[#1881c4]/50 flex items-center justify-center z-20 hidden md:flex shadow-[0_0_20px_rgba(24,129,196,0.4)]">
                 <ArrowRightLeft className="w-6 h-6 text-[#1881c4]" />
               </div>

               {/* iNextERP Panel */}
               <div className="flex-1 bg-[#151D30] rounded-xl p-6 border border-white/5 shadow-xl">
                 <div className="flex items-center gap-2 mb-6">
                   <Database className="w-5 h-5 text-[#1881c4]" />
             ...
             <div className="mt-8 flex justify-center items-center gap-2 text-sm text-gray-400 font-medium relative z-10">
               <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse" /> Real-time two-way sync verified
             </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 max-w-[1400px]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
             ...
             <div className="flex flex-col gap-6">
               <h2 className="text-2xl md:text-3xl font-bold text-gray-900 leading-tight">API & Developer Access</h2>
               ...
               <ul className="space-y-4 mb-4">
                 {["RESTful APIs", "Webhook support for real-time event notifications", "API rate limiting for stable, predictable performance", "Full developer documentation"].map((feat, i) => (
                   <li key={i} className="flex items-center gap-3 text-sm font-semibold text-gray-800">
                     <CheckCircle2 className="w-5 h-5 text-[#1881c4] shrink-0" /> {feat}
                   </li>
                 ))}
               </ul>
               <button className="w-max px-6 py-3.5 bg-[#1881c4] hover:bg-[#12659a] text-white rounded-xl font-bold transition-all flex items-center justify-center gap-2 shadow-md">
                 Explore API Docs <ArrowRight className="w-4 h-4" />
               </button>
             </div>

             {/* Code Snippet Block */}
             <div className="bg-[#0B1221] rounded-3xl p-6 md:p-8 flex-1 flex flex-col shadow-xl">
               <div className="flex items-center gap-2 mb-4 border-b border-white/10 pb-4">
                 <div className="w-3 h-3 rounded-full bg-red-500" />
                 <div className="w-3 h-3 rounded-full bg-yellow-500" />
                 <div className="w-3 h-3 rounded-full bg-green-500" />
                 <span className="text-gray-400 text-xs ml-2 font-mono">Example API Call</span>
               </div>
               <div className="flex-1 bg-[#050810] rounded-xl p-5 border border-white/5 font-mono text-xs overflow-x-auto custom-scrollbar shadow-inner">
                 <div className="text-gray-500 mb-2">// returns customer records with authentication via Bearer token</div>
...
{`{
  ...
  "`}<span className="text-blue-300">data</span>{`": [
    ...
    {"`}<span className="text-blue-300">id</span>{`": `}<span className="text-orange-400">102</span>{`, "`}<span className="text-blue-300">name</span>{`": "`}<span className="text-green-400">Sneha Kapoor</span>{`"}
        ...
        <div className="container mx-auto px-6 max-w-[1400px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
             <div className="p-6 rounded-2xl bg-[#F8FAFC] border border-gray-100 flex flex-col items-start hover:shadow-md transition-shadow">
               <div className="w-12 h-12 bg-blue-50 text-[#1881c4] rounded-xl flex items-center justify-center mb-4"><ShoppingCart className="w-6 h-6" /></div>
             ...
             <div className="p-6 rounded-2xl bg-[#F8FAFC] border border-gray-100 flex flex-col items-start hover:shadow-md transition-shadow">
               ...
               <h3 className="text-base font-bold text-gray-900 mb-2">Government & Compliance Systems</h3>
             ...
             <div className="p-6 rounded-2xl bg-[#F8FAFC] border border-gray-100 flex flex-col items-start hover:shadow-md transition-shadow lg:col-span-1 md:col-span-2">
             ...
             <div className="p-6 rounded-2xl bg-[#F8FAFC] border border-gray-100 flex flex-col items-start hover:shadow-md transition-shadow lg:col-span-2 md:col-span-2">
      ...
      <section className="py-16 bg-[#060B19] text-white">
        <div className="container mx-auto px-6 max-w-[1400px]">
          <div className="text-center mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6">
             {SECURITY_FEATURES.map((feat, i) => (
               <div key={i} className="flex flex-col items-center text-center gap-3 p-5 bg-white/5 rounded-xl border border-white/10 hover:bg-white/10 transition-colors">
                 <div className="w-12 h-12 bg-[#1881c4]/20 rounded-full flex items-center justify-center border border-[#1881c4]/30"><feat.icon className="w-5 h-5 text-[#1881c4]" /></div>
                 <div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6 max-w-[1400px]">
          <div className="relative rounded-[2rem] overflow-hidden bg-[#060B19] flex flex-col md:flex-row items-stretch justify-between shadow-2xl">
            ...
            <div className="md:w-1/2 min-h-[300px] relative w-full border-t md:border-t-0 md:border-l border-white/5">
               {/* Decorative background overlay in place of standard image */}
               <div className="absolute inset-0 bg-[#0A1022]" />
               ...
               <div className="absolute inset-0 bg-gradient-to-t md:bg-gradient-to-r from-[#060B19] via-[#060B19]/80 to-transparent" />
            </div>
