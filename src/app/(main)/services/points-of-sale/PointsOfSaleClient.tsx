              ...
              {WORKFLOW_STEPS.map((step, idx) => (
                ...
                >
                  <div className="flex flex-col items-center text-center w-24 md:w-28">
                    ...
                    <div className="text-[9px] md:text-[10px] text-gray-500 leading-tight px-1">
                      {step.desc}
                    </div>
                  </div>
                ...
                {TOUR_TABS.map((tab, i) => (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <tab.icon
                        className={`w-3.5 h-3.5 ${i === activeTab ? "text-white" : "text-gray-400"}`}
                      />{" "}
                      {tab.name}
                    </div>
                    {i === activeTab && (
            ...
            <div className="xl:col-span-6 order-2 xl:order-3 bg-white rounded-2xl p-6 shadow-xl border border-gray-100 flex flex-col gap-5 transition-all duration-300">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-2">
                <div className="bg-white rounded-xl p-4 border border-gray-200 flex flex-col items-center justify-center relative shadow-sm h-32 overflow-hidden">
                  <h5 className="text-[10px] font-bold text-gray-900 absolute top-3 left-3">
                    Activity Status
                  </h5>
                ...
                <div className="bg-white rounded-xl p-4 border border-gray-200 flex flex-col shadow-sm h-32">
                  <h5 className="text-[10px] font-bold text-gray-900 mb-3">
                    Recent Transactions
                  </h5>
                  <div className="flex-1 flex flex-col justify-between text-[10px]">
                    <div className="flex justify-between items-center border-b border-gray-100 pb-1.5">
                      <span className="text-gray-600">INV-4587</span>
                      <span className="text-green-500 font-bold">₹1,240</span>
                    </div>
                    <div className="flex justify-between items-center border-b border-gray-100 pb-1.5">
                      <span className="text-gray-600">INV-4588</span>
                      <span className="text-green-500 font-bold">₹3,450</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600">INV-4589</span>
        ...
        <div className="container mx-auto px-6 max-w-[1000px] text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              <span
                key={idx}
                className="px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-xs font-bold text-gray-700 shadow-sm"
              >
                {integration}
              </span>
            ))}
              ...
              <div className="relative z-10">
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li
                      key={i}
                      className="flex items-center gap-3 text-xs md:text-sm text-gray-300 font-medium"
                    >
              ...
              <div className="relative z-10 w-full">
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li
                      key={i}
                      className="flex items-center gap-3 text-xs md:text-sm text-gray-700 font-bold"
                    >
