        ...
        <div className="section-container max-w-[1400px]">
          <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
            ...
            <div className="xl:col-span-6 card-surface p-6 flex flex-col gap-5 transition-all duration-300">
               <div className="flex justify-between items-center border-b border-ink-100 pb-3">
                 ...
                 <div className="relative">
                   ...
                   <input type="text" placeholder="Search data..." className="pl-8 pr-3 py-1.5 bg-ink-50 border border-ink-150 rounded-md text-[10px] w-48 focus:outline-none" />
                 </div>
               </div>
            ...
            <div className="xl:col-span-3 flex justify-center items-center relative" role="img" aria-label="employee self service portal showing attendance and payslip access">
              <div className="w-60 h-125 bg-white rounded-[2rem] border-6 border-ink-900 shadow-2xl relative overflow-hidden flex flex-col">
      ...
      <section className="py-16 bg-white">
        <div className="section-container max-w-[1400px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
             ...
             {/* Feature 1 */}
             <div className="xl:col-span-1 card-surface card-surface-hover p-5 flex flex-col h-70">
      ...
      <section className="py-16 bg-ink-50 border-t border-ink-150">
        <div className="section-container max-w-[1400px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="card-surface p-6 flex flex-col items-start">
